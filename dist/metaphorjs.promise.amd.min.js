define("metaphorjs-promise",function(){var k=function(d){return"function"==typeof d},s=Object.prototype.toString,t=function(){var d={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(g){if(!g){if(null===g)return 6;if(void 0===g)return 7}var f=d[s.call(g)];return void 0===f?-1:1==f&&isNaN(g)?8:f}}(),n=function(d){var g,f;(f=!d)||(null===d||"object"!=typeof d?f=!1:(f=t(d),
f=2<f||-1==f),f=!f&&!k(d));return f?!1:k(g=d.then)?g:!1},h=Function.prototype.bind?function(d,g){return d.bind(g)}:function(d,g){return function(){return d.apply(g,arguments)}},u=function(d,g,f){setTimeout(function(){d.apply(g,f||[])},0)},q=function(d){var g=d.stack||Error().stack;if("undefined"!=typeof console&&console.log)u(function(){console.log(d);g&&console.log(g)});else throw d;};return function(){var d=[],g=!1,f="undefined"!=typeof process?process.nextTick:function(a){setTimeout(a,0)},r=function(){g=
!0;var a=d.shift();f(function(){a[0].apply(a[1],a[2]);d.length?r():g=!1},0)},l=function(a,b,c){c=c||[];d.push([a,b,c]);g||r()},m=function(a,b){return function(c){try{b.resolve(a(c))}catch(e){b.reject(e)}}},e=function(a,b){if(a instanceof e)return a;if(!(this instanceof e))return new e(a,b);var c;this._fulfills=[];this._rejects=[];this._dones=[];this._fails=[];if(0<arguments.length)if(c=n(a))a instanceof e?a.then(h(this.resolve,this),h(this.reject,this)):(new e(c,a)).then(h(this.resolve,this),h(this.reject,
...
_processRejectReason:function(a){this._processValue(a,this._doReject)},reject:function(a){if(this._triggered)return this;this._triggered=!0;this._processRejectReason(a);return this},then:function(a,b){var c=new e,d=this._state;0==d||0!=this._wait?(a&&k(a)?this._fulfills.push([m(a,c),null]):this._fulfills.push([c.resolve,c]),b&&k(b)?this._rejects.push([m(b,c),null]):this._rejects.push([c.reject,c])):1==d?a&&k(a)?l(m(a,c),null,[this._value]):c.resolve(this._value):2==d&&(b&&k(b)?l(m(b,c),null,[this._reason]):
c.reject(this._reason));return c},"catch":function(a){return this.then(null,a)},_done:function(){for(var a=this._dones,b;b=a.shift();)try{b[0].call(b[1]||null,this._value)}catch(c){q(c)}},done:function(a,b){var c=this._state;1==c&&0==this._wait?a.call(b||null,this._value):0==c&&this._dones.push([a,b]);return this},_fail:function(){for(var a=this._fails,b;b=a.shift();)try{b[0].call(b[1]||null,this._reason)}catch(c){q(c)}},fail:function(a,b){var c=this._state;2==c&&0==this._wait?a.call(b||null,this._reason):
...
for(var b=a.shift(),b=k(b)?e.fcall(b):e.resolve(c),c;c=a.shift();)n(c)?b=b.then(function(a){return function(){return a}}(c)):k(c)?b=b.then(c):b.resolve(c);return b};e.counter=function(a){var b=new e;b.countdown=function(){a--;0==a&&b.resolve()};return b};return e}()});
