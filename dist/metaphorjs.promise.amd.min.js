define("metaphorjs-promise",function(){var k=function(d){return"function"===typeof d},n=function(d){var f;return d&&(null!=d&&"object"===typeof d||k(d))?k(f=d.then)?f:!1:!1},g=Function.prototype.bind?function(d,f){return d.bind(f)}:function(d,f){return function(){return d.apply(f,arguments)}},q=function(d,f,k){setTimeout(function(){d.apply(f,k||[])},0)},r=function(d){var f=d.stack||Error().stack;q(function(){"undefined"!=typeof console&&console.log&&(console.log(d),f&&console.log(f))})};return function(){var d=
[],f=!1,q="undefined"!=typeof process?process.nextTick:function(a){setTimeout(a,0)},s=function(){f=!0;var a=d.shift();q(function(){a[0].apply(a[1],a[2]);d.length?s():f=!1},0)},l=function(a,b,c){c=c||[];d.push([a,b,c]);f||s()},p=function(a,b){return function(c){try{b.resolve(a(c))}catch(e){b.reject(e)}}},e=function(a,b){if(a instanceof e)return a;if(!(this instanceof e))return new e(a,b);this._fulfills=[];this._rejects=[];this._dones=[];this._fails=[];if("undefined"!=typeof a)if(n(a)||!k(a))this.resolve(a);
...
this._doReject)},reject:function(a){if(this._triggered)return this;this._triggered=!0;this._processRejectReason(a);return this},then:function(a,b){var c=new e,d=this._state;0==d||0!=this._wait?(a&&k(a)?this._fulfills.push([p(a,c),null]):this._fulfills.push([c.resolve,c]),b&&k(b)?this._rejects.push([p(b,c),null]):this._rejects.push([c.reject,c])):1==d?a&&k(a)?l(p(a,c),null,[this._value]):c.resolve(this._value):2==d&&(b&&k(b)?l(p(b,c),null,[this._reason]):c.reject(this._reason));return c},"catch":function(a){return this.then(null,
...
h instanceof e?h.done(m).fail(l):n(h)||k(h)?(new e(h)).done(m).fail(l):m(h);return b};e.race=function(a){if(!a.length)return e.resolve(null);var b=new e,c=a.length,d,f;for(d=0;d<c&&(f=a[d],f instanceof e?f.done(b.resolve,b).fail(b.reject,b):n(f)||k(f)?(new e(f)).done(b.resolve,b).fail(b.reject,b):b.resolve(f),b.isPending());d++);return b};return e}()});
